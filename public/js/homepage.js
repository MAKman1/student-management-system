    ...
    (function () {
      ...
      ************************************************************ */
      ...
      function setNavi(name,id){
        ...
        var $name = $('<div class="navi-name">'+name+'<span class="navi-name-bg">'+name+'<span class="navi-name-txt"></span></span></div>').appendTo($navi);
      ...
      function gotoScene(id){
        flags.jump = true;
        sceneM.gotoScene(id,{duration:1.0,onComplete:function(){ flags.jump = false; }});
